...
const Reception = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Đăng kí tài khoản cho bệnh nhân thành công!');
      navigate('/appointments/staff/booking');
    } catch (error) {
    ...
    <>
      ...
      <Container className="mt-5">
        <div className="col-md-8 mx-auto">
          <h2 className="text-center mb-4">Đăng ký tài khoản cho bệnh nhân</h2>
          <Form onSubmit={handleSubmit}>
            ...
            <div className="text-center mt-3">
              ...
              <Link to="/appointments/staff/booking" className="text-decoration-none">
                Đặt lịch
              </Link>
            </div>
